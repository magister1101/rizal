    ...
    <div class="container mt-5 text-light">
     <div class="row">
        <div class="col-md-12 right-side text-center">
                    ...
                    <br>
                    <p class="fs-5 fw-light justified animated slow zoomIn">
...
<section>
    <div class="container text-light">
        <div class="row">
          <div class="col-md-6 left-side" data-aos="flip-left">
            ...
            <div class="col-md-6 right-side d-flex justify-content-center align-items-center" data-aos="flip-right">
        ...
        <div class="col-md-6 left-side mt-2" data-aos="fade-left">
        ...
        <div class="col-md-12 text-center mt-5" data-aos="fade-up">
         ...
         <div class="col-md-4" data-aos="flip-right">
           <div class="card bg-dark text-light" style="width: 18rem;">
                <img src="assets/paci.jpg" class="card-img-top" alt="..." style="height: 350px;">
                <div class="card-body">
         ...
         <div class="col-md-4" data-aos="flip-right">
             <div class="card bg-dark text-light" style="width: 18rem;">
                <img src="assets/narci.jpg" class="card-img-top" alt="..." style="height: 430px;">
                <div class="card-body">
         ...
         <div class="col-md-4" data-aos="flip-right">
             ...
             <div class="col-md-4" data-aos="flip-right">
                        <div class="card bg-dark text-light" style="width: 18rem;">
                <img src="assets/maria.jpg" class="card-img-top" alt="..." style="height: 400px;">
                <div class="card-body">
        ...
        <div class="card bg-dark text-light" style="width: 18rem;">
         ...
         <div class="col-md-6 justify-content-center align-items-center mb-3 text-light text-center mt-5">
            <br>
            <p class="h3 fw-light justified" data-aos="fade-right">The lives of Rizal's siblings reflect a spectrum of joys and sorrows, triumphs and hardships, each contributing to the resilience and character of the Mercado family. Their collective experiences provided Rizal with a nurturing environment that nurtured his intellectual curiosity and nationalist sentiments.</p>
        </div>


         <div class="col-md-6 justify-content-center align-items-center mb-3 text-light text-center" data-aos="fade-left">
