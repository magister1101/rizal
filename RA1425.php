    ...
    <div class="container mt-5 text-light">
        <div class="row">
            ...
            <div class="col-md-6 right-side d-flex justify-content-center align-items-center">
                <img src="assets/rizal-ph.jpg" class="img-thumbnail" alt="" style="height:75%;" data-aos="flip-right">
            </div>
            <!-- end of col-md6 -->
            <div class="col-md-6 left-side" data-aos="fade-right">
            ...
            <!-- end of col-md6 -->
            <div class="col-md-6 left-side" data-aos="fade-left">
            ...
            <div class="col-md-6 right-side d-flex justify-content-center align-items-center">
                <img src="assets/rizal-3.jpg" class="img-thumbnail" alt="" style="height:75%;" data-aos="flip-left">
            </div>
            <!-- end of col-md6 -->
            <div class="col-md-6 right-side d-flex justify-content-center align-items-center" data-aos="flip-right">
            ...
            <!-- end of col-md6 -->
            <div class="col-md-6 right-side d-flex justify-content-center align-items-center">
                <img src="assets/rizal-5.jpg" class="img-thumbnail" alt="" style="height:100%;" data-aos="flip-left">
            </div>
            <!-- end of col-md6 -->
